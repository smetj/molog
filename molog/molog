...
#  
#  
from sys import path;path.append('/opt/molog/lib/modules')
...
if __name__ == '__main__':    
    def setup():    
        ...
        wb.registerModule ( ('wishbone.modules.jsonvalidator', 'JSONValidator', 'validateLogStashData'), schema='/opt/molog/lib/schema/broker', convert=True )
